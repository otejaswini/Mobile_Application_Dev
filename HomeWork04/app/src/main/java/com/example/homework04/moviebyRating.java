...
public class moviebyRating extends AppCompatActivity {
    ...
    protected void setValues ( int i){
        ...
        protected void onCreate (Bundle savedInstanceState){
            ...
            final Bundle extrasFromMain = getIntent().getExtras().getBundle("rating");
            ArrayList<movie> arrayRating = extrasFromMain.getParcelableArrayList("rating");
            ...
            finish.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //Intent intent = new Intent(moviebyRating.this, MainActivity.class);
